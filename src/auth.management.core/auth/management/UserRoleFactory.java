...
public class UserRoleFactory {
    ...
    public static UserRoleImpl createUserRole(String fullyQualifiedName, Object... base) {
        UserRoleImpl record = null;
        try {
            ...
            Constructor<?> constructor = null;
                for (int i = 0; i < constructorList.length; i++) {
                    try {
                        ...
                        record = (UserRoleImpl) constructor.newInstance(base);
