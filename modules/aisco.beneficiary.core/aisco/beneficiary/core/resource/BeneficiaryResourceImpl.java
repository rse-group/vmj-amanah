...
public class BeneficiaryResourceImpl extends BeneficiaryResourceComponent{
	...
	public Beneficiary createBeneficiary(VMJExchange vmjExchange, UUID id) {
		...
		String brith = (String) payload.get("brith");
		...
		Beneficiary beneficiary = BeneficiaryFactory.createBeneficiary("aisco.beneficiary.core.BeneficiaryImpl", id, fullName, address, email, brith, gender, Phone, allowance);
			return beneficiary;
	}
    ...
    public Beneficiary createBeneficiary(VMJExchange vmjExchange, UUID id, String objectName){
		...
		Beneficiary beneficiary = BeneficiaryFactory.createBeneficiary("aisco.beneficiary.core.BeneficiaryImpl", id, fullName, address, email, brith, gender, Phone, allowance, objectName);
			return beneficiary;
	}
