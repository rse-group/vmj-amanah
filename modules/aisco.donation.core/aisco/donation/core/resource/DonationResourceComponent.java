...
public abstract class DonationResourceComponent implements DonationResource {
    ...
    public DonationResourceComponent(){
        ...
        this.programRepository = new
        		RepositoryUtil<Program>(aisco.program.core.ProgramImpl.class);
    ...
    public abstract Donation createDonation(VMJExchange vmjExchange, UUID idDonation);
    public abstract Donation createDonation(VMJExchange vmjExchange, UUID idDonation, String objectName);
