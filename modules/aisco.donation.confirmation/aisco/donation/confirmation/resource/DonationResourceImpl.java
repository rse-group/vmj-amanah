...
public class DonationResourceImpl extends DonationResourceDecorator {
    ...
    public HashMap<String, Object> saveLiteDonation(VMJExchange vmjExchange) {
        List<String> keys = new ArrayList<String>(Arrays.asList("proofoftransfer", "nameDonation", "email", "phone",
                "descriptionDonation", "paymentMethodDonation", "idprogram", "amountDonation"));
    ...
    public Donation createDonation(VMJExchange vmjExchange, UUID idDonation) {
        ...
        Donation donationConfirmation = DonationFactory.createDonation(
                "aisco.donation.confirmation.DonationImpl", idDonation, donation, proofOfTransfer,
    ...
    private Donation updateStatusConfirmationDonation(VMJExchange vmjExchange) {
        ...
        if (savedDonation.getIncome() != null)
            throw new BadRequestException("Konfirmasi donasi dengan id " + idDonation + " sudah mempunyai income");
