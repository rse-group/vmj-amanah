...
public class JournalEntryFactory {
    private static final Logger LOGGER = Logger.getLogger(JournalEntryFactory.class.getName());

    public JournalEntryFactory() { }

    public static JournalEntry createJournalEntry(String fullyQualifiedName, 
        Object ... base)
    {
            ...
            Class<?> clz = Class.forName(fullyQualifiedName);
                ...
                for (int i = 0; i < constructorList.length; i++) {
                    try {
                        ...
                        record = (JournalEntry) constructor.newInstance(base);
        ...
        {
            LOGGER.severe("Failed to create instance of JournalEntry.");
